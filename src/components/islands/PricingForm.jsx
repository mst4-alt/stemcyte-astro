    ...
    <>
      <div className="pf-page" id="pricing-form">
        ...
        {step === 2 && (<form className="pf-checkout" autoComplete="on" onSubmit={e => e.preventDefault()} name="enrollment">
          ...
          <div className="pf-form-row"><div><input className="pf-form-input" name="fname" autoComplete="shipping given-name" placeholder="First name" value={form.firstName} onChange={uf('firstName')} /></div><div><input className="pf-form-input" name="lname" autoComplete="shipping family-name" placeholder="Last name" value={form.lastName} onChange={uf('lastName')} /></div></div>
          <div className="pf-form-row"><div><input className="pf-form-input" type="email" name="email" autoComplete="shipping email" placeholder="Email address" value={form.email} onChange={uf('email')} /></div><div><input className="pf-form-input" type="tel" name="phone" autoComplete="shipping tel" placeholder="Phone number" value={form.phone} onChange={uf('phone')} /></div></div>
          <div className="pf-form-full"><input className="pf-form-input" name="address" autoComplete="shipping street-address" placeholder="Street address (kit delivery)" value={form.street} onChange={uf('street')} /></div>
          <div className="pf-form-row-3"><div><input className="pf-form-input" name="city" autoComplete="shipping address-level2" placeholder="City" value={form.city} onChange={uf('city')} /></div><div><input className="pf-form-input" name="state" autoComplete="shipping address-level1" placeholder="State" value={form.state} onChange={uf('state')} /></div><div><input className="pf-form-input" name="zip" autoComplete="shipping postal-code" placeholder="ZIP code" value={form.zip} onChange={uf('zip')} /></div></div>
          ...
          {primaryIsBM && <div className="pf-form-row"><div><input className="pf-form-input" type="date" placeholder="Due date" value={form.dueDate} onChange={uf('dueDate')} autoComplete="off" /></div><div><input className="pf-form-input" type="date" name="bday" autoComplete="bday" placeholder="Your birthday" value={form.birthday} onChange={uf('birthday')} /></div></div>}
