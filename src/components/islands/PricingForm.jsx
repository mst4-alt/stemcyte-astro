    ...
    <>
      <div className="pf-page" id="pricing-form">
        ...
        {step === 2 && (<form className="pf-checkout" autoComplete="on" onSubmit={e => e.preventDefault()}>
          ...
          <div className="pf-form-row"><div><input className="pf-form-input" name="fname" autoComplete="given-name" placeholder="First name" value={form.firstName} onChange={uf('firstName')} /></div><div><input className="pf-form-input" name="lname" autoComplete="family-name" placeholder="Last name" value={form.lastName} onChange={uf('lastName')} /></div></div>
