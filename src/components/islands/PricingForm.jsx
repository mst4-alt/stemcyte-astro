    ...
    <>
      <div className="pf-page" id="pricing-form">
        ...
        {step === 2 && (<form className="pf-checkout" autoComplete="on" onSubmit={e => e.preventDefault()} name="enrollment">
          ...
          {primaryIsBM && <div className="pf-form-row"><div><span style={{ fontSize: 12, color: '#8A857A', display: 'block', marginBottom: 4 }}>Due date</span><input className="pf-form-input" type="date" placeholder="Due date" value={form.dueDate} onChange={uf('dueDate')} autoComplete="off" /></div><div><span style={{ fontSize: 12, color: '#8A857A', display: 'block', marginBottom: 4 }}>Your birthday</span><input className="pf-form-input" type="date" name="bday" autoComplete="bday" placeholder="Your birthday" value={form.birthday} onChange={uf('birthday')} /></div></div>}
